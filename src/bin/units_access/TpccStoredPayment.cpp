...
protected:
  Json::Value doPayment(int w_id, int d_id, int c_id, const std::string& c_last, int c_w_id, int c_d_id, float h_amount);
};

Json::Value TpccStoredPaymentTest::doPayment(int w_id, int d_id, int c_id, const std::string& c_last, int c_w_id,
                                             int c_d_id, float h_amount) {
