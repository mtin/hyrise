...
bool check_equality(PositionRange result_actual, std::vector<pos_t> result_expected) {
  ...
  result_actual.copyInto(result_actual_sorted);
...
TEST_F(GroupkeyTest, getBetween) {
  ...
  // existing values
  ASSERT_TRUE( check_equality(index.getPositionsForKeyBetween(0, 400),   {1,3,4} ));
  ASSERT_TRUE( check_equality(index.getPositionsForKeyBetween(0, 800),   {1,2,3,4} ));
  ASSERT_TRUE( check_equality(index.getPositionsForKeyBetween(200, 6),   {} ));
  ASSERT_TRUE( check_equality(index.getPositionsForKeyBetween(6, 200),   {4} ));
  ASSERT_TRUE( check_equality(index.getPositionsForKeyBetween(200, 400), {} ));
