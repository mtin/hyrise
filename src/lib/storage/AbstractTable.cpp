...
atable_ptr_t AbstractTable::copy_structure_modifiable(const field_list_t *fields, const size_t initial_size, const bool with_containers, const bool nonvolatile) const {
  std::vector<ColumnMetadata > metadata;
