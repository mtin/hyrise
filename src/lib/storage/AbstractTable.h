...
public:
   ...
   * @param with_containers Only used by derived classes.
   */
  virtual atable_ptr_t copy_structure_modifiable(const field_list_t *fields = nullptr, size_t initial_size = 0, bool with_containers = true, bool nonvolatile = false) const;
