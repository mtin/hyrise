...
public:
  ...
  atable_ptr_t copy_structure_modifiable(const field_list_t *fields = nullptr, size_t initial_size = 0, bool with_containers = true, bool nonvolatile = false) const override;
