...
#ifndef SRC_LIB_ACCESS_PAGED_INDEX_SCAN
#define SRC_LIB_ACCESS_PAGED_INDEX_SCAN
...
class PagedIndexScan : public PlanOperation {
public:
  virtual ~PagedIndexScan();
...
#endif // SRC_LIB_ACCESS_PAGED_INDEX_SCAN
